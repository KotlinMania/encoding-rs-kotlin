...
This file is the quick-reference operating contract for encoding-rs-kotlin. The longer
...
encoding-rs-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`encoding_rs`](https://crates.io/crates/encoding_rs). Upstream Rust is the behavioral oracle while the
