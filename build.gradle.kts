...
kotlin {
    ...
    swiftExport {
        moduleName = "EncodingRs"
        flattenPackage = "io.github.kotlinmania.encodingrs"
    }

    android {
        namespace = "io.github.kotlinmania.encodingrs"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "encoding-rs-kotlin", version.toString())

    pom {
        name.set("encoding-rs-kotlin")
        description.set("Kotlin Multiplatform port of hsivonen/encoding_rs - A Gecko-oriented implementation of the Encoding Standard")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/encoding-rs-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/encoding-rs-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/encoding-rs-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/encoding-rs-kotlin.git")
        }
    }
}
...
tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/encodingrs/codeql/_CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.encodingrs.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "embedSwiftExportForXcode",
    "assembleEncodingRsXCFramework",
    "assembleEncodingRsDebugXCFramework",
    "assembleEncodingRsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForEncodingRsXCFramework",
    "assembleReleaseIosFatFrameworkForEncodingRsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForEncodingRsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForEncodingRsXCFramework",
    "assembleDebugMacosFatFrameworkForEncodingRsXCFramework",
    "assembleReleaseMacosFatFrameworkForEncodingRsXCFramework",
    "assembleDebugTvosFatFrameworkForEncodingRsXCFramework",
    "assembleReleaseTvosFatFrameworkForEncodingRsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForEncodingRsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForEncodingRsXCFramework",
    "assembleDebugWatchosFatFrameworkForEncodingRsXCFramework",
    "assembleReleaseWatchosFatFrameworkForEncodingRsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForEncodingRsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForEncodingRsXCFramework",
